...
public final class AccountServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.AuthenticationRequest,
      com.google.protobuf.Empty> getAuthenticateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Authenticate",
      requestType = com.dylanlin.AccountService.Account.AuthenticationRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.AuthenticationRequest,
      com.google.protobuf.Empty> getAuthenticateMethod() {
    io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.AuthenticationRequest, com.google.protobuf.Empty> getAuthenticateMethod;
    if ((getAuthenticateMethod = AccountServiceGrpc.getAuthenticateMethod) == null) {
      synchronized (AccountServiceGrpc.class) {
        if ((getAuthenticateMethod = AccountServiceGrpc.getAuthenticateMethod) == null) {
          AccountServiceGrpc.getAuthenticateMethod = getAuthenticateMethod =
              io.grpc.MethodDescriptor.<com.dylanlin.AccountService.Account.AuthenticationRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Authenticate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.dylanlin.AccountService.Account.AuthenticationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setSchemaDescriptor(new AccountServiceMethodDescriptorSupplier("Authenticate"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.EventsRequest,
      com.dylanlin.AccountService.Account.EventsResponse> getRetrieveEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RetrieveEvent",
      requestType = com.dylanlin.AccountService.Account.EventsRequest.class,
      responseType = com.dylanlin.AccountService.Account.EventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.EventsRequest,
      com.dylanlin.AccountService.Account.EventsResponse> getRetrieveEventMethod() {
    io.grpc.MethodDescriptor<com.dylanlin.AccountService.Account.EventsRequest, com.dylanlin.AccountService.Account.EventsResponse> getRetrieveEventMethod;
    if ((getRetrieveEventMethod = AccountServiceGrpc.getRetrieveEventMethod) == null) {
      synchronized (AccountServiceGrpc.class) {
        if ((getRetrieveEventMethod = AccountServiceGrpc.getRetrieveEventMethod) == null) {
          AccountServiceGrpc.getRetrieveEventMethod = getRetrieveEventMethod =
              io.grpc.MethodDescriptor.<com.dylanlin.AccountService.Account.EventsRequest, com.dylanlin.AccountService.Account.EventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RetrieveEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.dylanlin.AccountService.Account.EventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.dylanlin.AccountService.Account.EventsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AccountServiceMethodDescriptorSupplier("RetrieveEvent"))
              .build();
        }
      }
    }
  ...
  public static abstract class AccountServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void authenticate(com.dylanlin.AccountService.Account.AuthenticationRequest request,
    ...
    /**
     */
    public void retrieveEvent(com.dylanlin.AccountService.Account.EventsRequest request,
        io.grpc.stub.StreamObserver<com.dylanlin.AccountService.Account.EventsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRetrieveEventMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.dylanlin.AccountService.Account.AuthenticationRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.dylanlin.AccountService.Account.EventsRequest,
                com.dylanlin.AccountService.Account.EventsResponse>(
  ...
  public static final class AccountServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AccountServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty authenticate(com.dylanlin.AccountService.Account.AuthenticationRequest request) {
    ...
    /**
     */
    public com.dylanlin.AccountService.Account.EventsResponse retrieveEvent(com.dylanlin.AccountService.Account.EventsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AccountServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AccountServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> authenticate(
        com.dylanlin.AccountService.Account.AuthenticationRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.dylanlin.AccountService.Account.EventsResponse> retrieveEvent(
        com.dylanlin.AccountService.Account.EventsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE:
          serviceImpl.authenticate((com.dylanlin.AccountService.Account.AuthenticationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_RETRIEVE_EVENT:
          serviceImpl.retrieveEvent((com.dylanlin.AccountService.Account.EventsRequest) request,
              (io.grpc.stub.StreamObserver<com.dylanlin.AccountService.Account.EventsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.dylanlin.AccountService.Account.getDescriptor();
    }
